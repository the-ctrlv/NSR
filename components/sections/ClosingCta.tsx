    ...
    >
      ...
      <div className="absolute top-[65%] left-[30%] lg:left-[10%] lg:top-[50%] h-full w-full max-w-none -translate-x-[40%] -translate-y-1/2">
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute inset-0 h-full w-full opacity-10 rotate-45 motion-reduce:animate-none animate-[spin_90s_linear_infinite]"
        />
        {/* eslint-disable-next-line @next/next/no-img-element -- decorative vector, next/image adds no value for local SVG */}
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute inset-0 h-full w-full opacity-10 motion-reduce:animate-none animate-[spin-reverse_130s_linear_infinite]"
        />
      </div>
